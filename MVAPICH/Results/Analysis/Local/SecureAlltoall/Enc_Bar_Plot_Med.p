...
#Block
plot file using 3:xtic(1) title "Naive SD" lc rgb "#edf8b1" fillstyle pattern 3,\
 "" using 4 title "Naive CHS" lt rgb "#7fcdbb" fillstyle pattern 3,\
 "" using 7 title "O-SD" lt rgb "#2c7fb8" fillstyle pattern 3
