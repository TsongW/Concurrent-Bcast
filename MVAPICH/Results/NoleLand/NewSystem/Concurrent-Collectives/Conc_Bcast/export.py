...
def write_to_spreadsheet(results, sheet_name, start_row):
	wb = openpyxl.load_workbook('../NS-ConcBcast-MVAPICH.xlsx')
	...
	wb.save('../NS-ConcBcast-MVAPICH.xlsx')
...
if __name__ == '__main__':
	...
	start_rows['out_7_91'] = 34
	start_rows['out_c_7_91'] = 63
	start_rows['out_8_128'] = 92
	start_rows['out_c_8_128'] = 121
