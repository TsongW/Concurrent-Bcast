    ...
    MPIR_Errflag_t *errflag )
{
    ...
    rank = comm_ptr->rank;
    if(rank==0){
        printf("%d - MPIR_Alltoall_inplace_MV2\n", sendcount);
    }
                            ...
                            MPIR_Errflag_t *errflag )
{
    ...
    rank = comm_ptr->rank;
    if(rank==0){
        printf("%d - MPIR_Alltoall_bruck_MV2\n", sendcount);
    }
                            ...
                            MPIR_Errflag_t *errflag )
{
    ...
    rank = comm_ptr->rank;
    if(rank==0){
        printf("%d - MPIR_Alltoall_ALG_MV2\n", sendcount);
    }
    /* Get extent of send and recv types */
    MPID_Datatype_get_extent_macro(recvtype, recvtype_extent);
    MPID_Datatype_get_extent_macro(sendtype, sendtype_extent);
                            ...
                            MPIR_Errflag_t *errflag )
{
    ...
    rank = comm_ptr->rank;
    if(rank==0){
        printf("%d - MPIR_Alltoall_pairwise_MV2\n", sendcount);
    }
    /* Get extent of send and recv types */
    MPID_Datatype_get_extent_macro(recvtype, recvtype_extent);
    MPID_Datatype_get_extent_macro(sendtype, sendtype_extent);
    ...
    MPIR_Errflag_t *errflag )
{
    ...
    comm_size = comm_ptr->local_size;
    if(comm_ptr->rank==0){
        printf("%d - MPIR_Alltoall_index_tuned_intra_MV2\n", sendcount);
    }
    MPID_Datatype_get_size_macro(sendtype, sendtype_size);
    ...
    MPIR_Errflag_t *errflag )
{
    ...
    comm_size = comm_ptr->local_size;
    if(comm_ptr->rank==0){
        printf("%d - MPIR_Alltoall_tune_intra_MV2\n", sendcount);
    }
    MPID_Datatype_get_size_macro(sendtype, sendtype_size);
    MPID_Datatype_get_size_macro(recvtype, recvtype_size);
    nbytes = sendtype_size * sendcount;
    ...
    MPIR_Errflag_t *errflag )
{
    ...
    rank = comm_ptr->rank;
    if(rank==0){
        printf("%d - MPIR_Alltoall_intra_MV2\n", sendcount);
    }
    /* Get extent of send and recv types */
    MPID_Datatype_get_extent_macro(recvtype, recvtype_extent);
    MPID_Datatype_get_extent_macro(sendtype, sendtype_extent);
