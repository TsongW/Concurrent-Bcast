...
enum MPIDU_Sched_entry_type {
    ...
    /**** Added by Mehran ****/
    MPIDU_SCHED_ENTRY_ENCRYPT,
    MPIDU_SCHED_ENTRY_DECRYPT,
    MPIDU_SCHED_ENTRY_BLOCKING_RECV
    /************************/
};
...
struct MPIDU_Sched_crypt {
    const void *inbuf;
    MPI_Aint in_len;
    MPI_Aint enc_overhead;
    MPI_Aint nonce_len;
    void *outbuf;
    MPI_Aint *out_len;
    MPI_Aint max_out_len;
};
...
struct MPIDU_Sched_entry {
    ...
    union {
        ...
        /***   Added by Mehran   ***/
        struct MPIDU_Sched_crypt crypt;
        /***************************/
